  ...
  wallpapers: Object.freeze([
    {
      ...
      price: 0,
      emoji: '⬜',
      gradients: ['#f8f9fa', '#e9ecef'],
      description: '깔끔한 기본 배경',
    },
    {
      key: 'blossom',
      name: '벚꽃',
      price: 500,
      emoji: '🌸',
      gradients: ['#fce4ec', '#f8bbd9'],
      description: '봄날 벚꽃이 흩날려요',
    },
    {
      key: 'night',
      name: '별밤',
      price: 800,
      emoji: '🌙',
      gradients: ['#0d1b4b', '#1a2a6c'],
      description: '별빛 가득한 밤하늘',
    },
    {
      key: 'dawn',
      name: '새벽',
      price: 1000,
      emoji: '🌅',
      gradients: ['#312060', '#5c3380'],
      description: '새벽의 신비로운 분위기',
    },
    {
      key: 'coral',
      name: '산호',
      price: 1200,
      emoji: '🪸',
      gradients: ['#fff3e0', '#ffe0b2'],
      description: '따뜻한 산호빛 감성',
    },
    {
      key: 'forest',
      name: '숲속',
      price: 1500,
      emoji: '🌿',
      gradients: ['#e8f5e9', '#c8e6c9'],
      description: '초록빛 숲 속의 고요함',
    },
    {
      key: 'library',
      name: '황금 도서관',
    ...
    },
    {
      ...
      price: 5000,
      emoji: '🚀',
      gradients: ['#050510', '#0a0520'],
      description: '광활한 우주 속 나만의 공간',
    },
  ]),
  props: Object.freeze([
...
function resolveRoomShopItem(itemKey) {
  for (const [category, items] of [
    ['wallpaper', ROOM_SHOP.wallpapers],
    ['prop', ROOM_SHOP.props],
  ]) {
