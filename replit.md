...
| POST | /api/auth/update-score | 평가원 점수 등록 (0~600) |
...
| GET  | /api/estate/tax | 세금 현황 (rate, pending, percentile, ticketPrice) |
...
- `users`: id, nickname, password_hash, university, gold, exp, tier, tickets, is_studying, study_started_at, last_tax_collected_at, tax_accumulated, mock_exam_score, created_at
